    ...
    <div className="flex justify-end w-full max-w-5xl pt-1 lg:p-0">
        <div className="flex items-center justify-between w-full border-b-2 border-emerald-700 lg:max-w-2xl lg:mb-0 lg:grid-cols-3">
            <div
              ...
              className="w-1/3 group px-4 py-5 rounded-lg border border-transparent flex justify-center transition-colors hover:cursor-pointer  hover:dark:border-neutral-700 hover:dark:bg-neutral-800/30"
